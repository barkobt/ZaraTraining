...
const PRESETS: Record<string, { label: string; icon: typeof Sparkles; desc: string; values: Record<ConfigKey, number> }> = {
  ...
  siki: {
    ...
    values: {
      competencyWeight: 4.0,
      fairnessWeight: 0.3,
      managerMorningPenalty: 200,
      managerNormalPenalty: 2000,
      dualPenalty: 400,
      sprinterDualPenalty: 1000,
      buddyViolationPenalty: 800,
      maxConsecutiveHours: 4,
    },
  },
  esnek: {
    label: "Esnek ⚡",
    icon: Heart,
    desc: "Az personelli günler için güvenli. Solver'a en geniş manevra alanı.",
    values: {
      competencyWeight: 1.5,
      fairnessWeight: 0.2,
      managerMorningPenalty: 20,
      managerNormalPenalty: 200,
      dualPenalty: 50,
      sprinterDualPenalty: 150,
      buddyViolationPenalty: 100,

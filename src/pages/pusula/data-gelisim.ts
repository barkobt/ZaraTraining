...
export const GUIDEBOOK: GuidebookSection[] = [
  ...
  section("Satış Danışmanı", "Başlangıç", SD_ASA, [
    ...
    [5, "Müşteri", "Müşteri önceliği ilkesi", "Yapabiliyor"],
    [6, "Müşteri", "Müşteri servisi temel yaklaşımı", "Yapabiliyor"],
    [7, "Müşteri", "İstek noktası ve istek hakimiyeti", "Geliştirilmeli"],
    [8, "Müşteri", "QR kullanımı ve müşteriyi yönlendirme", "Yapabiliyor"],
    [9, "Müşteri", "iPod ile ürün gösterme ve satış", "Geliştirilmeli"],
    [10, "Müşteri", "Geri bildirim kültürü: verme ve isteme", "Teorik"],
    [11, "Ürün", "Departmanlar ve buyer'lar", "Yapabiliyor"],
    [13, "Ürün", "Etiket okuma ve ürün içerik bilgisi", "Yapabiliyor"],
    [14, "Ürün", "Koleksiyonlar ve tipler", "Geliştirilmeli"],
    [16, "Süreçler", "Askılama ve askı türleri", "Öğretebilir"],
    [17, "Süreçler", "Chart sistemi ve vardiya: DC1 / DC2 / Hold", "Teorik"],
    [18, "Süreçler", "Zone hakimiyeti ve devretme", "Geliştirilmeli"],
    [19, "Süreçler", "Sprinter / Runner sistemi (360°)", "Teorik"],
    [21, "Süreçler", "Açılış ve kapanış süreçleri: düzen ve sıralama", "Yapabiliyor"],
    [22, "Süreçler", "Deadline ve verimlilik (productivity) bilinci", "Geliştirilmeli"],
  ]),
